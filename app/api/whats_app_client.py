...
class WhatsAppClient:
    ...
    def send_submitted_application_message(to_number, full_name, amount):
        msg = (
            f"Hi {full_name}, on {format_date(date.today())}, your loan application for {format_money(amount)} "
    ...
    def send_accept_loan_message(to_number, full_name, balance, due_date, total):
        msg = (
            f"Hi {full_name} you have taken out a loan of R{balance}"
    ...
    def send_past_due_message(to_number, full_name, total, due_date):
        msg = (
            f"Hi {full_name}, your balance is past due: {format_date(due_date)}. Your total of R{total} "
